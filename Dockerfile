...
RUN apt-get update && apt-get install -y net-tools inetutils-ping git libopencv-dev python-pip python-dev python-opencv && apt-get clean && rm -rf /var/lib/apt/lists/*
